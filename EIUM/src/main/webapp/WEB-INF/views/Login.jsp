	...
	<div class="login-container">
			<div class="login-form">
				...
				<h3><img class="logo" alt="logo" src="${contextPath}/resources/image/EIUM_logo.png"> EIUM</h3>
					...
					<h3 id="languages" >
						<img class="language" alt="KO" src="${contextPath}/resources/image/icons/icon_korea.png" onclick="alert('코리아')">
						<img class="language" alt="EN" src="${contextPath}/resources/image/icons/icon_usa.png" onclick="alert('코리아')">
						<img class="language" alt="CN" src="${contextPath}/resources/image/icons/icon_china.png" onclick="alert('코리아')">
						 <a href="<c:url value="Login.do?lang=ko" />">한국어</a> 
						<a href="<c:url value="Login.do?lang=en" />">English</a>
