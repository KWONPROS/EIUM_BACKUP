...
<script language="javascript">
	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			{Header:"사업자등록번호",Type:"Text",SaveName:"사업자등록번호",Hidden:1},			
			{Header:"사업자등록번호",Type:"Text",SaveName:"사업자등록번호",Hidden:1},			
			{Header:"사업자등록번호",Type:"Text",SaveName:"사업자등록번호",Hidden:1},			
			{Header:"사업자등록번호",Type:"Text",SaveName:"사업자등록번호",Hidden:1},			
			{Header:"사업자등록번호",Type:"Text",SaveName:"사업자등록번호",Hidden:1},			
		/* 	{Header:"회원 주소",Type:"Text",SaveName:"cust_address",MinWidth:150,KeyField:1 ,MultiLineText:1, Wrap:1},
			{Header:"회원 도시",Type:"Text",SaveName:"cust_city",MinWidth:150,KeyField:1 ,MultiLineText:1, Wrap:1},
			{Header:"회원 주",Type:"Text",SaveName:"cust_state",MinWidth:150},
			{Header:"회원 우편번호",Type:"Text",SaveName:"cust_zip",MinWidth:1000},
			{Header:"회원 나라",Type:"Text",SaveName:"cust_country",MinWidth:60},
			{Header:"회원 연락처",Type:"Text",SaveName:"cust_contact",MinWidth:60},
			{Header:"회원 이메일",Type:"Text",SaveName:"cust_email",MinWidth:60} */
			...
			사업장주소
				...
				SITE_ADDRESS
			사업장번지	SITE_ADDRESS_DETAIL
			사업장전화번호	SITE_CONTACT
			사업장팩스	SITE_FAX
			업태	SITE_CATEGORY
			종목	SITE_TYPE
			개업연월일	SITE_OPENBUSINESS_DATE
			폐업연월일	SITE_CLOSEBUSINESS_DATE
			본점여부	SITE_BUSINESS_AVAILABLE
