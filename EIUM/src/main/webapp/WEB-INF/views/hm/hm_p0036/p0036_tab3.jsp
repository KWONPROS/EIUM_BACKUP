...
<script>
	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			{Header:"사원코드",Type:"Text",SaveName:"employee_CODE",Edit:0,Width:"145"},
			{Header:"사원명",Type:"Text",SaveName:"employee_NAME",Edit:0,Width:"145"},
			{Header:"주민등록번호",Type:"Text",SaveName:"resident_RESISTRATION_NUMBER",Edit:0,Width:"170"},	
