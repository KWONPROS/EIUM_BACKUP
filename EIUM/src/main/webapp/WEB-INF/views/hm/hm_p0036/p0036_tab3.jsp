...
<script>
	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			{Header:"사원코드",Type:"Text",SaveName:"employee_CODE",Edit:0,Width:"140"},
			{Header:"사원명",Type:"Text",SaveName:"employee_NAME",Edit:0,Width:"140"},
			{Header:"주민등록번호",Type:"Text",SaveName:"resident_RESISTRATION_NUMBER",Edit:0,Width:"140"},	
			{Header:"부서",Type:"Text",SaveName:"department_NAME",Edit:0,Width:"140"},
			{Header:"직책",Type:"Text",SaveName:"duty_NAME",Edit:0,Width:"140"},
			{Header:"입사일",Type:"Text",SaveName:"employee_JOIN_DATE",Edit:0,Width:"140"},
			{Header:"퇴사일",Type:"Text",SaveName:"employee_RESIGNATION_DATE",Edit:0,Width:"140"},
			{Header:"재직기간",Type:"Text",SaveName:"working_YEARS",Edit:0,Width:"140"},
			{Header:"퇴사사유코드",Type:"Text",SaveName:"out_REASON_CODE",Edit:0,Width:"140"},
			{Header:"퇴사사유명",Type:"Text",SaveName:"out_REASON_NAME",Edit:0,Width:"140"},
				];
...
<script>
createIBSheet("mySheet", "1550px", "300px");
</script>
</div>
</form>
</body>
