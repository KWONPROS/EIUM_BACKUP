...
function LoadPage(){
	...
	initSheet.Cols=[
		...
		{Header:"상벌코드",Type:"Text",Width:100,SaveName:"hr_rnp_code",Align:"Center"},
		{Header:"포상/징계명",Type:"Text",Width:100,SaveName:"hr_rnp_name",Align:"Center"}
...
function mySheet2_OnDblClick(Row, Col, Value) { 
	 ...
	 var hr_assessment_name=selectRowJson.hr_assessment_name;
		 ...
		 document.getElementById("Chr_rnp_code").setAttribute('value', hr_rnp_code);
		 document.getElementById("Chr_rnp_name").setAttribute('value', hr_rnp_name);
