...
function mySheet_OnDblClick(Row,Col,Value){
	 ...
	 var CsiteName=selectRowJson.site_NAME;
	 var CdepartmentName=selectRowJson.department_NAME;
	 var CdutyName=selectRowJson.duty_NAME;
	 
	 window.opener.set_p02value(Ccode,Cname,CsiteName,CdepartmentName);
