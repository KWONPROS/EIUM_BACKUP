	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			initSheet2.Cols = [
					...
					{Header:"이수여부",Type:"Combo",SaveName:"finish_YN",InsertEdit:0,"ComboText":"Y|N", "ComboCode":"Y|N",Width:80},
					{Header:"출석점수",Type:"Text",SaveName:"attendence_SCORE",InsertEdit:0,Width:80},
