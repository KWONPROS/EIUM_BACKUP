...
<script type="text/javascript">
	...
	function LoadPage() {
		...
		initSheet.Cols = [ 
			 	...
			 	{Header:"교육코드",Type:"Text",SaveName:"employee_TRAINING_CODE", MinWidth:50,  Align:"Center", Edit: 0,Hidden:1},	
		        {Header:"교육명",Type:"Text",SaveName:"employee_TRAINING_NAME", MinWidth:50,  Align:"Center", Edit: 0},	
		        {Header:"사원코드",Type:"Text",SaveName:"employee_CODE", MinWidth:80, Align:"Center", Edit: 0},
				{Header:"사원명",Type:"Text",SaveName:"employee_NAME", MinWidth:120, Align:"Center", Edit: 0},
				{Header:"시작일",Type:"Text",SaveName:"employee_TRAINING_START_DATE", MinWidth:120, Align:"Center", Edit: 0},
				{Header:"종료일",Type:"Text",SaveName:"employee_TRAINING_END_DATE", MinWidth:120, Align:"Center", Edit: 0},
				{Header:"평가",Type:"Text",SaveName:"assessment_DESC", MinWidth:120, Align:"Center", Edit: 0}
		];
...
<body onload="LoadPage()">
	...
	<form name="frm">
       ...
       <span class="kindofsearch">조회조건</span>
				...
				<input type="text" id="Psite_name"><a href="javascript:showPopup_option();"><img src="${contextPath}/resources/image/icons/icon_plus.png"></a>
				<span class="kindofsearch">재직구분</span>
				<input type="text" id="Pwork"><a href="javascript:showPopup_work();"><img src="${contextPath}/resources/image/icons/icon_plus.png"></a>
				<span class="kindofsearch">직급</span>
				<input type="text" id="Pwork"><a href="javascript:showPopup_position();"><img src="${contextPath}/resources/image/icons/icon_plus.png"></a>
