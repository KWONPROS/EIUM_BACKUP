...
<script type="text/javascript" src="${contextPath}/resources/tab/js/ibtab.js"></script>
<script type="text/javascript" src="${contextPath}/resources/tab/js/ibtabinfo.js"></script>
<link rel="stylesheet" href="${contextPath}/resources/tab/css/ibtab-style.css">
...
<script language="javascript">
   ...
   function LoadPage() {
      ...
      initData.Cols = [
       ...
       {Header:"사원코드",Type:"Text",SaveName:"employee_code",Width:60,Align:"Center"},
       {Header:"사원명",Type:"Text",SaveName:"employee_name",Width:50, Edit:0},
      ];
                     ...
                     <div style="height:100%;width:45%;float:left">
                        <div id="tab1" class="ib-tab-tab">
                           <div class="ib-tab-tabs-item">
                              <a class="ib-tab-tabs-item__link"> <span class="ib-tab-tabs-item__title">기본정보</span></a> 
                              <a class="ib-tab-tabs-item__link"> <span class="ib-tab-tabs-item__title">상세정보</span></a> 
                              <a class="ib-tab-tabs-item__link"> <span class="ib-tab-tabs-item__title">기본정보</span></a>
                              <a class="ib-tab-tabs-item__link"> <span class="ib-tab-tabs-item__title">기본정보</span></a>
                              <a class="ib-tab-tabs-item__link"> <span class="ib-tab-tabs-item__title">기본정보</span></a>
                              <a class="ib-tab-tabs-item__link"> <span class="ib-tab-tabs-item__title">기본정보</span></a>
                           ...
                           <div class="ib-tab-contents__item">
                              <table class="tb01" style="width: 100%; min-width:400px">
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="5" class="bg02_l" id="EMP_ADDRESS"></td>
                                 </tr>
