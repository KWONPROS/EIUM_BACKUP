...
function mySheet2_OnDblClick(Row, Col, Value) { 
	 ...
	 var sitecode=selectRowJson.site_CODE;
	 var sitename=selectRowJson.site_NAME;
		 console.log(sitecode);
		 document.getElementById("CsiteCode").setAttribute('value', sitecode);
		 document.getElementById("CsiteName").setAttribute('value', sitename);
		console.log(document.getElementById("CsiteCode").value);
		  opener.document.getElementById("PsiteCode").value=document.getElementById("CsiteCode").value;
		  opener.document.getElementById("PsiteName").value=document.getElementById("CsiteName").value;
		opener.setSite();
