...
@Repository("P0005_01DAO")
public class P0005_01DAOImpl implements P0005_01DAO {
	@Autowired
...
/*	@Override
	...
	public List<P0005_01VO> searchList(Map<String, Object> searchMap) throws DataAccessException {
		List<P0005_01VO> list = sqlSession.selectList("mapper.sm_p0005.searchList_01", searchMap);
		return list;
	}
